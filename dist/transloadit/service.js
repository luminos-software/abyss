...
exports.Transloadit = {
    ...
    uploadFile({ fileUri, template, extraParams }) {
        ...
        return react_native_fetch_blob_1.default.fetch('POST', `${API_URL}/assemblies`, { 'Content-Type': 'multipart/form-data' }, [
            { name: 'params', data: params },
            { name: 'signature', data: signature },
            { name: 'file', filename: 'file', data: react_native_fetch_blob_1.default.wrap(fileUri) },
